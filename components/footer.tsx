        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-[#6CC0E1] rounded-lg flex items-center justify-center">
                <span className="text-[#001A33] font-bold text-xl">TM</span>
              </div>
              <div>
                <span className="font-bold text-lg">TM Services</span>
